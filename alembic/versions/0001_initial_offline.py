...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("mastery_score", sa.Real(), nullable=False, server_default="0"),
    ...
    op.create_table(
        ...
        sa.Column("interval_days", sa.Real(), nullable=True),
        sa.Column("previous_interval_days", sa.Real(), nullable=True),
        sa.Column("stability", sa.Real(), nullable=True),
        sa.Column("difficulty_adjustment", sa.Real(), nullable=True),
        sa.Column("overdue_days", sa.Real(), nullable=False, server_default="0"),
